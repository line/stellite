...
bool NetworkTransactionClient::RewriteHttpResponse(
  ...
  dest->alpn_negotiated_protocol = src->alpn_negotiated_protocol;
  dest->request_time = src->request_time.ToTimeT();
  dest->response_time = src->response_time.ToTimeT();
  ...
  dest->was_alpn_negotiated = src->was_alpn_negotiated;
