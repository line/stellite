...
#ifndef STELLITE_FETCHER_HTTP_FETCHER_CORE_H_
#define STELLITE_FETCHER_HTTP_FETCHER_CORE_H_
 ...
 private:
  ...
  class Registry {
   public:
    ...
    void AddHttpFetcherCore(HttpFetcherCore* core);
    void RemoveHttpFetcherCore(HttpFetcherCore* core);
   ...
   private:
    std::set<HttpFetcherCore*> fetchers_;
...
#endif  // STELLITE_FETCHER_HTTP_FETCHER_CORE_H_
