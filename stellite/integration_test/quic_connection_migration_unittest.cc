...
class SwitchableDispatcher : public ThreadDispatcher {
 ...
 private:
  ...
  std::vector<std::unique_ptr<ThreadDispatcher>> dispatcher_container_;
...
class QuicSwitchableDispatcherServer {
 ...
 private:
  ...
  std::unique_ptr<QuicSwitchableDispatcherThreadWorker> worker_;
...
class QuicConnectionMigrationTest : public testing::Test {
 public:
  ...
  // QUIC server
  std::unique_ptr<QuicSwitchableDispatcherServer> quic_server_;

  // QUIC test client
  IPEndPoint server_address_;
  std::unique_ptr<stellite::HttpClientContext> http_client_context_;
