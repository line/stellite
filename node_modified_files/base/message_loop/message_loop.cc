...
typedef MessagePumpNode MessagePumpForIO;
#endif
...
// TODO(rvargas): Get rid of the OS guards.
  ...
  typedef MessagePumpNode MessagePumpForUI;
#endif
...
void MessageLoop::BindToCurrentThread() {
  ...
  // attach delegate to message pump for Node
#if defined(OS_POSIX)
  static_cast<MessagePumpNode*>(pump_.get())->set_delegate(this);
#endif
...
bool MessageLoopForUI::WatchFileDescriptor(
    int fd,
    bool persistent,
    MessagePumpNode::Mode mode,
    MessagePumpNode::FileDescriptorWatcher *controller,
    MessagePumpNode::Watcher *delegate) {
  return static_cast<MessagePumpNode*>(pump_.get())->WatchFileDescriptor(
      fd,
      persistent,
      mode,
      controller,
