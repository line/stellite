...
#elif defined(OS_POSIX)
  typedef MessagePumpNode::Watcher Watcher;
  typedef MessagePumpNode::FileDescriptorWatcher
      FileDescriptorWatcher;

  enum Mode {
    WATCH_READ = MessagePumpNode::WATCH_READ,
    WATCH_WRITE = MessagePumpNode::WATCH_WRITE,
    WATCH_READ_WRITE = MessagePumpNode::WATCH_READ_WRITE
  };
#endif
