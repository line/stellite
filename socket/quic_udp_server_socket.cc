...
QuicUDPServerSocket::QuicUDPServerSocket(net::NetLog* net_log,
...
int QuicUDPServerSocket::SetReceiveBufferSize(int size) {
  return socket_.SetReceiveBufferSize(size);
}

int QuicUDPServerSocket::SetSendBufferSize(int size) {
...
const BoundNetLog& QuicUDPServerSocket::NetLog() const {
